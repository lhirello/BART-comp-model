  ...
  is_missing <- ifelse(is.na(pumps), 1, 0)
  
  ## set NA values in 'pumps' and 'explosion' to -1
  pumps <- ifelse(is.na(pumps),-1, pumps)
  explosion <- ifelse(is.na(explosion),-1, explosion)
