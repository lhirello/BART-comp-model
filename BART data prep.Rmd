...
subset_df <- bart_df[bart_df$participant %in% c("14", "15", "16"), ]
...
tic()
output24 <- bart_ewmv(data="subset_df.tsv", niter=2000, nwarmup=1000, nchain=4, ncore=4)
toc()

saveRDS(output24, file = "bart_model_output24.rds")
